...
public class Redaccio {
    ...
    public void introduirNoticiaRedactor(){
        ...
        Noticia noticia = demanarTipusEsport(titular);
    ...
    private Noticia demanarTipusEsport(String titular){
        String esport;
        Noticia a;
        Scanner scanner = new Scanner(System.in);
        System.out.println("Introdueix el tipus d´esport:");
        esport = scanner.nextLine();

        switch (esport){
            case "futbol":
                a = crearNoticiaFutbol(titular);
                break;
            case "basquet":
                a = crearNoticiaBasquet(titular);
                break;
            case "tenis":
                a = crearNoticiaTenis(titular);
                break;
            case "f1":
                a = crearNoticiaF1(titular);
                break;
            case "motociclisme":
                a = crearNoticiaMoto(titular);
                break;
            default:
                a = new Noticia("Error");
        }
    ...
    private Noticia crearNoticiaMoto(String titular){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Introdueix l´equip:");
        String equip = scanner.nextLine();

        NoticiaMotociclisme nf1 = new NoticiaMotociclisme(titular, equip);
        return nf1;
    }

    private Noticia crearNoticiaF1(String titular){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Introdueix l´escuderia:");
        String escuderia = scanner.nextLine();

        NoticiaF1 nf1 = new NoticiaF1(titular, escuderia);
        return nf1;
    }

    private Noticia crearNoticiaTenis(String titular){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Introdueix el tenista:");
        String tenista = scanner.nextLine();

        NoticiaTenis nt = new NoticiaTenis(titular, tenista);
        return nt;
    }

    private Noticia crearNoticiaBasquet(String titular){
        Scanner scanner = new Scanner(System.in);
        ...
        NoticiaBasquet nb = new NoticiaBasquet(titular, competicio, club);
        return nb;
    }

    private Noticia crearNoticiaFutbol(String titular){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Introdueix la competicio:");
        String competicio = scanner.nextLine();
        ...
        NoticiaFutbol nf = new NoticiaFutbol(titular, jugador, competicio, club);
        return nf;
    }
